...
inline bool operator<(const NodeAddress &lhs, const NodeAddress &rhs) {
...
bool send_message(int fd, MessageType type, const string &payload);

// This reads a typed message with payload.
bool recv_message(int fd, MessageType &type, string &payload);
